...
import com.example.comida.viewmodels.profile.PrivacyPolicyViewModel
...
fun PrivacyPolicyScreen(
    ...
    val policy = viewModel.privacyPolicy.collectAsStateWithLifecycle()
    ...
    Scaffold(
        ...
        Column(
            ...
            Image(
                painter = painterResource(R.drawable.ic_privacy_policy_screen_icon),
                contentDescription = "Privacy Policy Screen image"
            )

            Text(
                text = policy.value.title,
            ...
            LazyColumn(
                ...
                items(policy.value.policies) { policyItem ->
                    Row(
                        modifier = Modifier
                            .fillMaxWidth(),
